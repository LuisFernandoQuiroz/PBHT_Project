...
@WebServlet(name="db_Connect_Emp", urlPatterns={"/db_Connect_Emp"})

public class db_Connect_Emp extends HttpServlet {
    ...
    protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			prep = connect.prepareStatement("INSERT INTO orders (cid_1, cid_2, cid_3, cid_4, cid_5, cid_6, cid_7, cid_8, cid_9, bid_1, bid_2, bid_3) VALUES (?,?,?,?,?,?,?,?,?,?,?,?);");
			prep.setInt(1, f1);
			prep.setInt(2, f2);
			prep.setInt(3, f3);
			prep.setInt(4, f4);
			...
			request.getRequestDispatcher("/order_placed_emp.html").forward(request, response);
		} catch(Exception e){
